...
public class Restrictions {
     ...
     * 不为空
     */
    public static SimpleExpression isNotNull(String fieldName, boolean ignoreNull) {
        return new SimpleExpression(fieldName, null, Criterion.Operator.IS_NOT_NULL);
    }
